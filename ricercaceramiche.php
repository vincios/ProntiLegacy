...
if ($ok==1)
{
    ...
    {
        $query = 'SELECT * FROM pronticeramiche WHERE cliente = "' . mysqli_escape_string($db, $_REQUEST['nome']) . '" and eliminato=0 ORDER by ceramica';
        ...
        <table width="100%"  border="0">
            ...
            <tr>
                <td align="center" width="25%" style="color:#000066"><strong>CERAMICA</strong></td>
    ...
    {
        $query2 = " SELECT * FROM pronticeramiche WHERE ceramica = '" . mysqli_escape_string($db, $_REQUEST['ceramica']) . "' and eliminato=0";
