...
<table width="100%"  border="0">
  ...
  <tr>
    <td><div align="center" class="Stile1">Inserimento Marazzi </div></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
...
<?
	if ($ok == 1){
		...
		$query="insert into marazzi (nome,indirizzo,telefono,colore) values(\"" . mysqli_escape_string($db, $_REQUEST['nome']) . "\",'". mysqli_escape_string($db, $_REQUEST['indirizzo']) ."','". mysqli_escape_string($db, $_REQUEST['telefono']) ."', \"" . mysqli_escape_string($db, $_REQUEST["colore"]) . "\")";
