...
<form method="post" name="form" action="<? print $_SERVER['PHP_SELF'] ?>">
    <table width="100%"  border="0">
        ...
        <tr>
            ...
            <td><textarea rows="4" cols="20" name="note" maxlength="2000"><? print $_REQUEST['telefono'] ?></textarea></td>
        </tr>
        <tr>
...
if ($ok == 1){
    ...
    $query="insert into marazzi (nome,indirizzo,telefono,note,colore) values('$nome', '$indirizzo', '$telefono', '$note', '$colore')";
