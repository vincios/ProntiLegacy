...
$id = $_REQUEST['idcer'];
$query = "SELECT * FROM ceramica WHERE idcer = '".$id."'";
...
<table width="100%"  border="0">
    ...
    <tr>
        <td><div align="center" class="Stile1">Modifica Ceramica </div></td>
    </tr>
    <tr>
        <td>&nbsp;</td>
    </tr>
</table>
<form method="post" name="form" action="functionModificaCeramica.php">
    ...
    <table width="100%"  border="0">
        ...
        <tr>
            ...
            <td><input type="text" name="idgruppo" value="<? print $array['idgruppo'] ?>" maxlength="20"></td>
        </tr>
        <tr>
