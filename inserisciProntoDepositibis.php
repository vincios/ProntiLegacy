...
<form method="post" name="form" action="<? print $_SERVER['PHP_SELF'] ?>">
    <table width="100%"  border="0">
        <tr>
            ...
            <td colspan="4"><input type="text" name="deposito" value="<? print $_REQUEST['deposito'] ?>" maxlength="45"></td>
        </tr>
        <tr>
            <td><div align="right" class="Stile2">
                    <div align="right">Ceramica</div>
                </div></td>
            <td colspan="4"><input type="text" name="ceramica" value="<? print $_REQUEST['ceramica'] ?>" maxlength="45"></td>
        </tr>
        <tr>
            <td><div align="right"><span class="Stile2">Cliente</span></div></td>
            <td colspan="4"><input type="text" name="cliente" value="<? print $_REQUEST['cliente'] ?>" maxlength="45"></td>
        </tr>
        <tr>
            <td><div align="right"><span class="Stile2">Quintali</span></div></td>
            <td colspan="4"><input type="text" name="quintali" value="<? print $_REQUEST['quintali'] ?>" maxlength="45"></td>
        </tr>
        <tr>
            <td><div align="right"><span class="Stile2">Palette</span></div></td>
            <td colspan="4"><input type="text" name="palette" value="<? print $_REQUEST['palette'] ?>" maxlength="45"></td>
        </tr>
        <tr>
            <td><div align="right"><span class="Stile2">Note</span></div></td>
            <td colspan="4"><input type="text" name="note" value="<? print $_REQUEST['note'] ?>" maxlength="45"></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td width="3%">&nbsp;</td>
            <td width="6%" bordercolor="#000000" bgcolor="#CCCCCC"><div align="center" class="Stile3"><a href="gestioneProntoDeposito.php?nome=<? print $_REQUEST['deposito'] ?>"><strong>Finito</strong></a></div></td>
            <td width="53%">&nbsp;</td>
        </tr>
    </table>
</form>
...
if ($ok == 1){
    ...
    $query = "SELECT * FROM depositi WHERE nome = '".mysqli_escape_string($db, $deposito)."'";
...
//        $query="insert into prontidepositi (Deposito,Ceramica,Cliente,quintali,note) values(\"" . mysqli_escape_string($db, $deposito) . "\",'". mysqli_escape_string($db, $_REQUEST['ceramica']) ."','". mysqli_escape_string($db, $_REQUEST['cliente']) ."','" . mysqli_escape_string($db, $_REQUEST['quintali']) ."','". mysqli_escape_string($db, $_REQUEST['note']) ."')";
        ...
        print '	<script language="javascript">	
	         document.location.href="inserisciProntoDepositibis.php?deposito='.$deposito.'"</script>';
    }
    else{
