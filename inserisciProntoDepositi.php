...
<table width="100%"  border="0">
  ...
  <tr>
    ...
    <td width="68%"><input type="text" name="ceramica" value="<? print $_REQUEST['ceramica'] ?>" maxlength="20"></td>
  </tr>
  <tr>
    <td><div align="right"><span class="Stile2">Cliente</span></div></td>
    <td><input type="text" name="cliente" value="<? print $_REQUEST['cliente'] ?>" maxlength="20"></td>
  </tr>
  <tr>
