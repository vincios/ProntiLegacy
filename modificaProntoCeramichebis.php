<?
	...
	$id = $_REQUEST['id'];
	$query = "SELECT * FROM pronticeramiche WHERE id = '".$id."'";
...
<table width="100%"  border="0">
  ...
  <tr>
    <td><div align="center" class="Stile1">Modifica ProntoCeramica </div></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
</table>
<form method="post" name="form" action="functionModificaProntoCeramichebis.php">
