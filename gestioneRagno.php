<? 
	...
	$query = "SELECT * FROM ragno ORDER by nome";
...
<table width="100%"  border="0">
  <tr>
    ...
    <td width="17%"><form name="form1" method="post" action="inserisciRagno.php">
	<input type="submit" name="Submit" value="Inserisci Ragno">
	</form></td>
  </tr>
</table>
            ...
            <tr>
			  ...
			  <table width="222" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  ...
                  <td width="187"><div align="left" class="Stile2">Cancella Ragno </div></td>
                </tr>
				<tr>
				...
				<tr>
                  ...
                  <td width="187"><div align="left" class="Stile2">Modifica Ragno </div></td>
                </tr>
              </table></td>
			  ...
			  <table width="317" align="left" border="0" cellpadding="0" cellspacing="2">
                ...
                <tr>
                  ...
                  <td width="48" bgcolor="#FFFFFF" align="center"><a href="cancellaRagno.php?id=<? print $id ?>"><img src="img/cancellaAdmin.gif" border="0"></a></td>
                  <td width="48" bgcolor="#FFFFFF" align="center"><img src="img/adminView.gif" border="0" onClick="return ApriPopup('infoRagno.php?id=<? print $id; ?>',350,300)"></a></td>
                  <td width="48" bgcolor="#FFFFFF" align="center"><a href="modificaRagno.php?id=<? print $id ?>"><img src="img/nuovoAdmin.gif" width="26" height="25" border="0"></a></td>  
			    </tr>				                                
                <?
			}
			?>
