...
if ($ok==1)
{
    ...
    {
        $query = " SELECT * FROM prontimarazzi WHERE cliente = '".mysqli_escape_string($db, $_REQUEST['nome'])."' and eliminato=0 ORDER by deposito";
    ...
    {
        $query2 = " SELECT * FROM prontimarazzi WHERE deposito = '".mysqli_escape_string($db, $_REQUEST['deposito'])."' and eliminato=0 ORDER by cliente";
