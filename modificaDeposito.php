<?
	...
	$id = $_REQUEST['id'];
	$query = "SELECT * FROM depositi WHERE id = '".$id."'";
...
<table width="100%"  border="0">
  ...
  <tr>
    <td><div align="center" class="Stile1">Modifica Deposito </div></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
</table>
<form method="post" name="form" action="functionModificaDeposito.php">
