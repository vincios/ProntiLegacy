...
<?	
	if ($ok==1)
	{
		...
		{
			$query = " SELECT * FROM prontidepositi WHERE cliente = '".mysqli_escape_string($db, $_REQUEST['nome'])."' and eliminato=0 ORDER by deposito,ceramica";
		  ...
		  <tr>
			...
			<td align="center" width="36%" style="color:#000066"><strong>CERAMICA</strong></td>
		...
		{
			$query2 = " SELECT * FROM prontidepositi WHERE ceramica = '".mysqli_escape_string($db, $_REQUEST['ceramica'])."' and eliminato=0 ORDER by deposito,cliente";
...
<table width="100%"  border="0">
  ...
  <tr>
    <td height="30"><div align="right" class="Stile2">Ricerca per ceramica </div></td>
