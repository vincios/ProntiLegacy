...
$query = "UPDATE prontimarazzi SET Deposito='$deposito', Cliente='$cliente', dds='$dds', quintali='$quintali', palette='$palette', note='$note' WHERE id=$id";
$ris = mysqli_query($db, $query) or die(mysqli_error($db));

print '	<script language="javascript">	
	         document.location.href="gestioneProntoMarazzi.php?nome='.$deposito.'";
	           </script>';
?>