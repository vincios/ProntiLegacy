...
$query = "UPDATE prontidepositi SET Deposito='$deposito', Ceramica='$nome', Cliente='$cliente',autista='$autista', quintali='$quintali', palette='$palette', note='$note' WHERE id=$id";
