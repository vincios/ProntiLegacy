...
<table width="100%"  border="0">
  ...
  <tr>
    <td><div align="center" class="Stile1">Inserimento ProntoRaggruppati </div></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
...
<table width="100%"  border="0">
  ...
  <tr>
    ...
    <td width="68%"><input type="text" name="materiale" value="<? print $_REQUEST['materiale'] ?>" maxlength="15"></td>
  </tr>
  <tr>
    <td><div align="right"><span class="Stile2">Cliente</span></div></td>
    <td><input type="text" name="cliente" value="<? print $_REQUEST['cliente'] ?>" maxlength="25"></td>
  </tr>
  <tr>
...
<?
	if ($ok == 1){
		...
		$_REQUEST['materiale']=strtoupper($_REQUEST['materiale']);
